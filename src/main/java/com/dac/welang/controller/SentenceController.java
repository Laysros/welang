...
import com.dac.welang.repo.WordBankRepository;
...
public class SentenceController {
	...
	String english2[] = {"Whats your (full) name?",
			"How old are you?",
			"Whats your Birthday?",
			...
			"You are walking to work. There is a dog drowning in the canal on the side of the street. Your boss told you if you are late one more time you're fired. Do ave the dog?",
	...
	String french[] = {"Quand est-ce que tu arrives?",
			...
			"as des frères ou des soeurs?",
			"Est ce que tu aimes cet endroit?",
			"Qu’est ce que tu aimes boire d’habitude?",
			"Es tu déjà venu ici avant/ Est ce que tu viens souvent ici?",
			"Comment a été ta journée ?",
			"Tu écoutes quel type de musique?",
			"Quels est ton plat préféré ?",
			"Quels genres de films / séries TV aimes-tu regarder?",
			"Quel est ton restaurant préféré ?",
			"Qu’est ce fais en rentrant du travail ?",
			"Qu’est ce que tu fais pour t’amuser?",
			"Où as tu fais tes études?",
			"Quelle est ta passion dans la vie ? Qu’est-ce qui te fais rêver ?",
			"Quelle est le voyage que tu as le plus aimé ?",
			"Es tu plutôt du matin ou du soir ?",
			"Parles moi de ton meilleur ami, qui c’est ?",
			"Dis moi à quoi ressemble ta journée idéale ?",
			"Quel est ta chanson préférée ?",
			"Quels sont les moments qui ont marqués et changés ta vie ?",
			"Quelle est la chose la plus stupide que tu n’aies jamais faite?",
			"Quel est pour toi la meilleure façon pour se détendre ?",
			"Ca serait quoi une soirée romantique pour toi ?",
			"Quelle est le plat que tu préfère préparer ?",
			"Quels sont tes projets dans les 3 ans à venir ?",
			"Quel est ton film préféré de tout les temps?",
			"Quel est le plus mauvais film que tu n’aies jamais vu?",
			"Quel est le meilleur concert que tu as assisté?",
			"Quels sont les 3 endroits que tu aimerais visiter ?",
			"Quel est ta destination préférée pour les vacances ?",
			"Quel est ton souvenir le plus drôle que tu as jamais eu ?",
			"Quel est l’achat la plus stupide que tu aies jamais fait ?",
			"Est-ce que tu joue d’un instrument ?",
			"Qu’est-ce qui t’as donné le plus de joie ou de plaisir dans ta vie ?",
			"Quel est ton moment le plus drôle mais le plus embarrassant ?",
			"Si tu devais te décrire comme un animal, tu choisirais quoi ?",
			"Quel est ton nom complet, tu as plusieurs prénoms ?",
			"Quel est la date de ton anniversaire, et tu es née où ?",
			"As-tu un petit surnom?",
			"C’est quoi ton types de sorties préférées ?",
			"Quel est ton signe astrologique ?",
			"As-tu des frères et des sœurs? Si oui, combien ?",
			"Quel est le livre que tu peux lire et relire encore et encore ?",
			"Est-ce que tu as des tatouages ? Si oui combien et sont ils ?",
			"Quand tu as accepté ce rendez vous, tu as pensé à quoi ? Qu’est-ce que tu attendais de moi ?",
			"Tu sens vraiment bon, c’est quoi ton parfum ?",
			"Pratiques-tu un sport? Si oui lequel ?",
			"Aimes-tu danser ?",
			"Tu rêvais de quoi quand tu étais petite ?",
			"Tu fumes ? Si oui combine de cigarettes?",
			"Comment étais tu quand tu étais enfant?",
			"Tu préfères les chats ou les chiens ?"
			};
	String khmer[] = {"Welcome 	សូម​ស្វាគមន៍ (sohm swaakohm)",
			"Hello(General greeting) 	ជំរាបសួរ (johm riab sua)",
			"How are you? 	អ្នកសុខសប្បាយទេ (niak sohk sabaay te?)",
			"Reply to 'How are you?' 	ខ្ងុំសុខសប្បាយទេ ចុះអ្នក?(kh'nyohm sohk sabaay, coh neak?)",
			"Long time no see 	ខានជួបយូរហើយ [kʰaːn cuəp juː haəj]",
			"What's your name? 	អ្នកឈ្មោះអី? (niak ch'muah ei?)",
			"My name is ... 	ខ្ងុំឈ្មោះ ... (kh'nyohm ch'muah ...)",
			"Where are you from? 	អ្នកមកពីប្រទេសណា?(niak mao pii prateh naa?)",
			"I'm from ... 	ខ្ងុំមកពី ...(kh'nyohm mao pii ...)",
			"Pleased to meet you 	ខ្ញុំ​ត្រេក​អរណាស់​ដែលបាន​ស្គាល់​លោក   (kh'nyom trawk aw naa dael baan skoal loak)",
			"(Morning greeting) 	អរុណសួស្ដី (arun soou sduii)",
			"Good afternoon  	ទិវាសួស្ដី (tivaa soou sduii)",
			"Good evening 	សាយ័ណ្ហសួស្ដី (saayan soou sduii)",
			"Good night 	រាត្រីសួស្តី [riətrəi suəsdəi]",
			"Goodbye (Parting phrases) 	លាសិន​ហើយ (lia suhn hao-y)",
			"ជួបគ្នាថ្ងៃក្រោយ (juab kh'nia th'ngay)",
			"Good luck 	សូមឲ្យ​បាន​ជោគ​ជ័យ (soam aoy baan joak jaay)",
			"Cheers! Good Health! (Toasts used when drinking) 	ជល់មួយ (jul mouy) លើកដាច់ (lerk dach)",
			...
			"Bon voyage /Have a good journey 	ទៅអោយបានសុខ (tuoo aoy baan sok) 	",
			"I don't understand 	មិនយល់ទេ (min yuhl dtay)",
			"Please speak more slowly 	សូម​និយាយ​យឺតៗ (sohm niyay yeut yeut)",
			"Please say that again 	សូមនិយាយម្តងទៀត (sohm niyay m'dawng tiat)",
			"Please write it down 	សូមសរសេរពាក្យនោះឱ្យខ្ងុំ(sohm sawse piak nooh ao-y kh'nyohm)",
			"Do you speak Khmer? 	អ្នក​ចេះ​និយាយ​ភាសា​ខ្មែរ​ទេ? (niak jeh phiasaa kh'mai te?)",
			"Do you speak English? 	អ្នកចេះភាសាអង់គ្លេសទេ? [neak ceʰ phiəsaː ɔŋgleːʰ teː?]",
			"How do you say ... in Khmer? 	...ខ្មែរ​ថា​ម៉េច? (... kh'mai tha mait?)",
			"Excuse me 	សុំទោស (sohm toh)",
			"Pardon? 	អ្នក​និយាយ​ថា​ម៉េច (niak niyey tha mait?)",
			"How much is this? 	នេះថ្លៃប៉ុន្មាន? (nih th'lay pohnmaan?)",
			"Sorry 	សុំទោស (sohm toh)",
			"Please 	សូម (sohm)",
			"Thank you 	ឣរគុណ (aw kohn)",
			"Reply to thank you 	ឣត់ឣីទេ (awt ei te)",
			"សូម​អញ្ជើញ (sohm anjoe-in)",
			"Where's the toilet? 	បង្គន់​នៅ​ឯណា? (bawng-kohn neuv ai naa?)",
			"This gentleman/lady will pay for everything 	 ",
			"Would you like to dance with me? 	អ្នក​ចង់​រាំ​ជាមួយ​ខ្ញុំទេ? (nek chong rohm ji-mooay kinyom dtay?)",
			"I love you 	បងស្រលាញ់អូន - m>f អូនស្រលាញ់បង - f>m",
			"Get well soon 	ឆាប់ជា [cʰap ciə]",
			"Leave me alone! 	កុំប៉ះពាល់! [kom paʰ poal]",
			"Help! 	ជួយ​ខ្ញុំ​ផង! (juay kh'nyohm phawng!)",
			"Fire! 	ភ្លើងឆេះ! (phloeng cheh!)",
			"Stop! 	ឈប់! (chohp!)",
			"Call the police! 	ជួយ​ហៅ​ប៉ូលិស​មក! (juay hav polih mao!)",
			"Christmas and New Year greetings 	រីករាយថ្ងៃបុណ្យណូអែល ហើយសួស្ដីឆ្នាំថ្មី [riʔriəj tʰŋai bon nouʔael haəj suəsdəi cʰnam tʰməi]",
			"Birthday greetings 	រីករាយថ្ងៃខួបកំណើត[riʔriəj tʰŋai kʰuəp kɔmnaət]",
	...
	@RequestMapping(value = "/showMoreSentences", method = RequestMethod.POST)
	@ResponseBody
	public String showMoreSentences(@RequestParam String language,@RequestParam String keyword, @RequestParam int page) {
		
		/*for(int i=0; i<english.length; i++){
			wordbankRepository.save(new WordBank("English", english[i], tags[i%6]));
		}
		for(int i=0; i<english2.length; i++){
			wordbankRepository.save(new WordBank("English", english2[i], tags[i%6]));
		}
		for(int i=0; i<french.length; i++){
			wordbankRepository.save(new WordBank("French", french[i], tags[i%6]));
		}
		for(int i=0; i<khmer.length; i++){
			wordbankRepository.save(new WordBank("Cambodian", khmer[i], tags[i%6]));
		}*/
		List<WordBank> sentences = new ArrayList<>();
		sentences = wordbankRepository.searchByKeyword(language, keyword, new PageRequest(page, 5));
		return new JSONArray(sentences).toString();
	}
	@RequestMapping(value = "/searchByKeyword", method = RequestMethod.POST)
	@ResponseBody
	public String searchByKeyword(@RequestParam String language, @RequestParam String keyword) {
		List<WordBank> sentences = new ArrayList<>();
		sentences = wordbankRepository.searchByKeyword(language, keyword, new PageRequest(0, 5));
		return new JSONArray(sentences).toString();
	}
	
	@RequestMapping(value = "/searchByLanguageTagAndKeyword", method = RequestMethod.POST)
	@ResponseBody
	public String searchByLanguageTagAndKeyword(@RequestParam String language,@RequestParam String tag, @RequestParam String keyword) {
		List<WordBank> sentences = new ArrayList<>();
		sentences = wordbankRepository.searchByLanguageTagAndKeyword(language, tag, keyword, new PageRequest(0, 5));
		return new JSONArray(sentences).toString();
	}
